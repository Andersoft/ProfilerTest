...
# Remove these 2 lines below for the application to start working again
# See more about profiler chaining here: https://docs.contrastsecurity.com/en/-net-core-profiler-chaining.html
